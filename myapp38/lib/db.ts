...
db.exec(`
  -- followers - ✅ myapp38 - 스미카 맞춤 / Schema Alignment
  ...
  -- following - ✅ myapp38  - 스미카 맞춤 / Schema Alignment
  ...
  CREATE INDEX IF NOT EXISTS idx_following_inbox ON following(inbox);
  CREATE INDEX IF NOT EXISTS idx_following_created ON following(created_at DESC);
  ...
  -- likes - ✅ myapp23 + myapp38 created_at 추가!
  ...
  -- announces - ✅ myapp24 + myapp29 + myapp38
  ...
  CREATE INDEX IF NOT EXISTS idx_announces_created ON announces(created_at DESC);
